...
sz = [10 4];
varTypes = ["double","double","cell","string"];
varNames = ["zeta","omega_ratio","solution","test_FLAG"];
...
for omega = 0.1 : 0.1 : 1.0
    ...
    if test_p_data >= - 1e-13
        sol_test_FLAG = 'true';
    else
        sol_test_FLAG = 'false';
    end

    dat(table_index,:) = {zeta,omega/omega_0,sol.a,sol_test_FLAG};   
    table_index = table_index + 1;
end

writetable(dat,'test_outputCODE.csv')
